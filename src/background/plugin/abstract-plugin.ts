...
import { IHTTPService } from "../../interfaces/background/http/i-http-layer";
import { IWindowService } from "../../interfaces/background/services/i-window-service";
...
import {
    AppConfig,
    IConfigService,
} from "../../interfaces/background/services/i-config-service";
import { CoreEvents } from "../core-events";
import { INotificationService } from "../../interfaces/background/services/i-notification-service";
...
export abstract class AbstractPlugin<T extends AbstractState<any>> {
    ...
    protected _httpLayer!: IHTTPService;
    ...
    broadcastStateChange() {
        this._internalRelay.emit(CoreEvents.NEW_PLUGIN_STATE, {
